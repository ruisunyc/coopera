...
function onsbt()
{
	...
	{
	window.alert("对不起，新闻通告标题不能为空，请输入新闻通告标题。");
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="150">
		...
		<tr>
			...
			<p style="margin-top: 6px">公告内容：</td>
			<td align="right">
			<textarea id="editor1" name="editor1" rows="10" cols="80" style="width:100%;height:500px;visibility:hidden;"><%= strCons[0][3]%></textarea>
			<script type="text/javascript">
				...
				{
					document.write(
						'<strong><span style="color: #ff0000">Error</span>: KindEditor not found</strong>.' +
			...
			{
				var editor = KindEditor.replace( 'editor1' );
				var econs = window.editor1.value;
				editor.setData( econs );
			
				KindEditor.setupCKEditor( editor, '/ckfinder/' ) ;
