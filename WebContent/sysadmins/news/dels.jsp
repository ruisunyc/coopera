...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	  ...
	  <form method="post" action="dels.jsp" name="form1" style="line-height: 100%; margin-top: 0; margin-bottom: 0">
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" height="25">
					<tr>
						...
						<p style="margin-top: 3px; margin-bottom: 0"><span class="STYLE19">请输入您要删除的工告的标题</span></td>
						<td>
						&nbsp;
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <%
        String getCons[][] = null;
        if (getInfos.getTitle(strtitle,"工作通告") != null)
        {
      ...
      <tr>
        ...
        <td height="25" bgcolor="#FFFFFF" width="80"><div align="center" class="STYLE21"><%out.println("<a class=\"style1\" target=\"_self\" title=\""+getCons[i][1].trim()+"\" href=del.jsp?ID="+getCons[i][0]+"&strtitle="+strtitle+">删除</a>");%></div></td>
      </tr>
		<%}}}%>
      </table></td>
  </tr>
