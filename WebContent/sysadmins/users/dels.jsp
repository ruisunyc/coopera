...
<jsp:useBean id="getInfos" class="com.lib.sys.Userinfo" scope="page"/>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        <td height="25" bgcolor="d3eaef" class="STYLE6"><div>
			<span class="STYLE10">&nbsp;&nbsp;&nbsp;&nbsp;用户姓名</span></div></td>
        <td width="200" height="25" bgcolor="d3eaef" class="STYLE6"><div align="center">
			<span class="STYLE10">真实姓名</span></div></td>
        <td width="300" height="25" bgcolor="d3eaef" class="STYLE6"><div align="center">
			<span class="STYLE10">所在部门</span></div></td>
        <td width="100" height="25" bgcolor="d3eaef" class="STYLE6" align="center">
		操作</td>
      </tr>
      <%
        ...
        strTotal = "0";
        strPages = "0";
        if (getInfos.getUsers("") != null)
        {
            getCons = getInfos.getUsers("");
            if (getCons.length > 0)
            {
      ...
      <tr>
        ...
        <td height="25" bgcolor="#FFFFFF" class="STYLE19" width="200"><div align="center"><%= getCons[i][3]%></div></td>
        <td height="25" bgcolor="#FFFFFF" class="STYLE19" width="300"><div align="center"><%= getCons[i][4]%></div></td>
        <td height="25" bgcolor="#FFFFFF" class="STYLE19" width="100" align="center"><div align="center" class="STYLE21"><%out.println("<a class=\"style1\" target=\"_self\" title=\""+getCons[i][1].trim()+"\" href=del.jsp?ID="+getCons[i][0]+">删除</a>");%></div></td>
      </tr>
      <%
		}
		}
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		{
			out.println("<td width=49><div align=center><img src=images/main_58.gif width=40 height=15></div></td><td width=49><div align=center><img src=images/main_60.gif width=40 height=15></div></td>");
		}
		%>
